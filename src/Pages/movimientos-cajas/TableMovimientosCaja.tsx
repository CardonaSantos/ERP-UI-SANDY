...
import { columnasMovimientos } from "./movimientos-columns";
import DialogMovimientoDetails from "./dialog-movimiento-details";
...
function MovimientosTable({
  ...
  console.log("La data de movimientos registros es: ", data);
