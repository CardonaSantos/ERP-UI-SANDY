...
export const RequisitionEditor = () => {
  ...
  return (
    <PageTransition titleHeader="Edición de requisición">
      <Card>
        <CardHeader>
          ...
          <div className="flex justify-between items-center">
            <CardDescription>
              Modifica las cantidades o desmarca productos que ya no necesites
              en esta requisición.
            </CardDescription>
                ...
                <Table>
                  ...
                  <TableBody>
                    {currentItems.map((item) => {
                      ...
                      const currentQty =
                        selected[item.productoId]?.cantidad || 0;
